...
const EditRecordForm = ({ isOpen, onClose, buttonText = "Cập nhật", defaultValues, onSubmit }: EditRecordFormProps) => {
                ...
                <FormField
                  ...
                  render={({ field, fieldState }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Nhập mã bệnh nhân" required disabled />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field, fieldState }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Nhập mã mẫu bệnh phẩm" required disabled />
                      </FormControl>
                      <FormMessage>{fieldState.error?.message}</FormMessage>
                    </FormItem>
                  )}
